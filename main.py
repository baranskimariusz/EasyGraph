...
class EasyGraphApp(tk.Tk):
    def __init__(self):
        ...
        self.button1 = tk.Button(container, text='Close', width=20, command=self.destroy)
        self.button1.pack(side="right", padx=10, pady=10)
        self.button2 = tk.Button(container, text="Load data", width=20, command=self.load_csv)
